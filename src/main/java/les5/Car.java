...
public class Car implements Runnable {
    ...
    public Car(Race race, int speed, CyclicBarrier waitForPrepareBarrier, CountDownLatch raceStartNotifier, FinishNotifier finishNotifier) {
        this.race = race;
        this.speed = speed;
